...
def upload_tracks_and_metadata(analysis_metadata,
    ...
    dataframe_name = analysis_metadata.item()['experiment_groups'][experiment_group]['df']
    track_name = analysis_metadata.item()['experiment_groups'][experiment_group]['tracks']
    path_tracks = analysis_metadata.item()['experiment_groups'][experiment_group]['path']
    path_outputs = analysis_metadata.item()['path_outputs']
...
#         print(track)
    ...
    analysis_metadata.item()['experiment_groups'][experiment_group]['number_of_track_splits'] = number_of_track_splits
